			  	...
			  	<form action="{{ route('dealers.update',$dealers->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
					  ...
					  <div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="deskripsi" class="form-control" value="{{ $a->deskripsi }}"  required>
